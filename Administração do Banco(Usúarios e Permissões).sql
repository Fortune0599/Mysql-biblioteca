...
CREATE USER 'admin_biblioteca'@'localhost' IDENTIFIED BY 'Fortune123'; 

GRANT ALL PRIVILEGES ON biblioteca.* TO 'admin_biblioteca'@'localohost'; 

-- criar usuario somente leitura 

CREATE USER 'consulta_biblioteca'@'localhost' IDENTIFIED BY 'Fortune@leitura123'; 
GRANT SELECT ON biblioteca.* TO 'consulta_biblioteca'@'localhost';
